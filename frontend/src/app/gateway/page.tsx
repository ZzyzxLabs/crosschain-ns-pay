...
import { DepositFromEvmButton } from "@/components/DepositFromEvmButton";
        ...
        <div className='flex flex-wrap items-center justify-between gap-4'>
          <div>
            ...
            <p className='mt-2 max-w-2xl text-sm text-slate-300'>
              Manage deposits, balances, and cross-chain transfers across EVM
              and Solana from one place.
            </p>
          </div>
          <Link
            href='/'
